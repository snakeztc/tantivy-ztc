...
use crate::postings::recorder::{BufferLender, NothingRecorder, Recorder, TFAndPositionRecorder, TermFrequencyRecorder, TermScoreRecorder};
    ...
    fn index_text(
        ...
        let mut sink = |token: &Token| {
            ...
            if token.text.len() <= MAX_TOKEN_LEN {
                ...
                self.subscribe(term_index, doc_id, token.position as u32,
                               token.score as u32, &term, heap);
            } else {
                info!(
