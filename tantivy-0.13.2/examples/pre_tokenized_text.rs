...
fn main() -> tantivy::Result<()> {
    ...
    let short_man_json = r#"{
        "title":[{
            "text":"The Old Man",
            "tokens":[
                {"offset_from":0,"offset_to":3,"position":0,"text":"The","position_length":1, "score": 1},
                {"offset_from":4,"offset_to":7,"position":1,"text":"Old","position_length":1, "score": 1},
                {"offset_from":8,"offset_to":11,"position":2,"text":"Man","position_length":1, "score": 1}
            ]
        }]
    }"#;
